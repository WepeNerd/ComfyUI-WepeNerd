...
class WN_ResolutionSuggest:
    ...
    proportionally resized width/height snapped to a chosen divisor (16 or 32).
    ...
    @staticmethod
    def _snap(value: float, divisor: int, mode: str) -> int:
        """Snap a float value to the nearest multiple of *divisor*."""
        if mode == "floor":
    ...
    def suggest(self, width: int, height: int, target: int,
                resize_mode: str, divisor: int, snap_mode: str):
